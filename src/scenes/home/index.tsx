     ...
     {/* image and main header*/}  
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <img  alt="home-page-image" src={HomePageText} />
                            </div>
                        </div> 
                        ...
                        >
                          Best gym training to get the body that you've always dreamed about 
...

            {
                isAboveMediumScreens && (
                    <div 
                    className='h-[150px] w-full bg-primary-500 py-10 '
                    >
                        <div 
